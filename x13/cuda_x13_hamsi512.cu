...
* + optimized by sp - may 2018 (+60% faster)
*/
...
__host__
void x16_hamsi512_cpu_init(int thr_id, uint32_t threads)
{
...
__constant__ static uint64_t __align__(64) c_PaddedMessage80[10];
__constant__ static uint32_t __align__(64) c_c[17];
__constant__ static uint32_t __align__(64) c_h[16];

#if defined(__CUDA_ARCH__)

__constant__ static const uint32_t d_alpha_n[] = {
	0xff00f0f0, 0xccccaaaa, 0xf0f0cccc, 0xff00aaaa, 0xccccaaaa, 0xf0f0ff00, 0xaaaacccc, 0xf0f0ff00,
	0xf0f0cccc, 0xaaaaff00, 0xccccff00, 0xaaaaf0f0, 0xaaaaf0f0, 0xff00cccc, 0xccccf0f0, 0xff00aaaa,
	0xccccaaaa, 0xff00f0f0, 0xff00aaaa, 0xf0f0cccc, 0xf0f0ff00, 0xccccaaaa, 0xf0f0ff00, 0xaaaacccc,
	0xaaaaff00, 0xf0f0cccc, 0xaaaaf0f0, 0xccccff00, 0xff00cccc, 0xaaaaf0f0, 0xff00aaaa, 0xccccf0f0
...
__constant__ static const uint32_t d_alpha_f[] = {
	0xcaf9639c, 0x0ff0f9c0, 0x639c0ff0, 0xcaf9f9c0, 0x0ff0f9c0, 0x639ccaf9, 0xf9c00ff0, 0x639ccaf9,
	0x639c0ff0, 0xf9c0caf9, 0x0ff0caf9, 0xf9c0639c, 0xf9c0639c, 0xcaf90ff0, 0x0ff0639c, 0xcaf9f9c0,
	0x0ff0f9c0, 0xcaf9639c, 0xcaf9f9c0, 0x639c0ff0, 0x639ccaf9, 0x0ff0f9c0, 0x639ccaf9, 0xf9c00ff0,
	0xf9c0caf9, 0x639c0ff0, 0xf9c0639c, 0x0ff0caf9, 0xcaf90ff0, 0xf9c0639c, 0xcaf9f9c0, 0x0ff0639c
...
__constant__ static uint32_t d_T512[64][16] = {
...
void x16_hamsi512_setBlock_80(uint64_t *pdata)
{
	...
	*(uint2x4*)&h1[0 * 4] = *(uint2x4*)&pdata[0];
	*(uint2x4*)&h1[8 * 4] = *(uint2x4*)&pdata[4];

	((uint2*)h1)[8] = ((uint2*)pdata)[8];
	((uint2*)h1)[9] = ((uint2*)pdata)[9];
	...
	uint32_t c[17] = { c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, cA, cB, cC, cD, cE, cF, ((uint32_t *)pdata)[18] };

	cudaMemcpyToSymbol(c_h, h, sizeof(c_h), 0, cudaMemcpyHostToDevice);
	cudaMemcpyToSymbol(c_c, c, sizeof(c_c), 0, cudaMemcpyHostToDevice);
...
void x16_hamsi512_gpu_hash_80(const uint32_t threads, const uint32_t startNonce, uint64_t *g_hash)
{
	...
	if (thread < threads)
	{
		uint32_t h[16] = { c_h[0], c_h[1], c_h[2], c_h[3], c_h[4], c_h[5], c_h[6], c_h[7], c_h[8], c_h[9], c_h[10], c_h[11], c_h[12], c_h[13], c_h[14], c_h[15] };

		uint32_t c0 = c_c[0], c1 = c_c[1], c2 = c_c[2], c3 = c_c[3];
		uint32_t c4 = c_c[4], c5 = c_c[5], c6 = c_c[6], c7 = c_c[7];
		uint32_t c8 = c_c[8], c9 = c_c[9], cA = c_c[10], cB = c_c[11];
		uint32_t cC = c_c[12], cD = c_c[13], cE = c_c[14], cF = c_c[15];
